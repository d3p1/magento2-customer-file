...
A [Magento 2](https://business.adobe.com/products/magento/magento-commerce.html) development that allows you to implement the incorporation of a customer file attribute (with its respective file uploader) in an easy way.
...
```
composer require d3p1/module-customer-file
